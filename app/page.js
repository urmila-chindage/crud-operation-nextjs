...
const HomePage = async  () => {
  ...
  return (
    <main>
      <HeadingText
      title='Student Data'
      description='Student Data Here'
      />
      <Navbar />
      <div className='flex flex-col px-4 py-4 container mx-auto'>
      <div>
          ...
          <tbody>
            {
              contacts.map((contact) => (
                <tr key={contact.id}>
                  ...
                  <td className='border-t-2 text-center border-gray-200 px-4 py-3 flex items-center gap-2 justify-center'>
